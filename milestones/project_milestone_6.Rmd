---
title: "Flu outbreak (simulated) and vaccine uptake in California"
...
plot_ly(
  ...
  #   text = ~paste('County: ', county, '<br>COVID Vax per 1,000 pop: ', rate_partial_vaccinated, '<br>Severe Flu per 1,000 pop: ', rate_severe),
  hoverinfo = "text"
) %>%
  layout(
...
#   mode = "markers",
#   marker = list(color = "darkcyan", line = list(color = "darkslateblue", width = 2)),  
#   text = ~paste('County: ', county, '<br>COVID Vaccination: per 1,000 population ', rate_partial_vaccinated, '<br>Severe Flu: per 1,000 population ', rate_severe),
#   hoverinfo = "text"
# ) %>%
#   layout(
#     title = "County Rates of Severe Flu and Total Partially Vaccinated for COVID-19, California, 2022-2023",
...
plot1 <- plot_ly(flu_vax_race,
                 ...
                 text = ~paste(rate_severe, "per 1,000 population"))
...
plot2 <- plot_ly(flu_vax_race,
                 ...
                 text = ~paste(rate_total_partial, "per 1,000 population"))
...
plot_ly(flu_vax_quarter, x = ~quarter, y = ~rate_total_partial, type = "bar", name = "Partial COVID Vaccination", 
        text = ~paste(rate_total_partial, "per 1,000 population"), marker = list(color = "darkcyan")) %>%
  add_trace(x = ~quarter, y = ~rate_infections, type = "bar", name = "Flu Diagnosed", 
            text = ~paste(rate_infections, "per 1,000 population"), marker = list(color = "darkslateblue")) %>%
  layout(
...
**Overall, this analysis indicates that there is no strong correlation between COVID-19 vaccination rates and flu rates and severity from Quarter 3,2022, to Quarter 2,2023, in California. Therefore, efforts to promote flu vaccination might be not effective at this stage. Further analysis is needed to modernize strategies for vaccination interventions.**
