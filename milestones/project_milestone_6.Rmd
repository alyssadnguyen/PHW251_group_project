...
Rpubs: <https://rpubs.com/alyssadnguyen/milestone_6>
...
plot_ly(
  ...
  text = ~paste('County: ', county, '<br>COVID Vaccination:', rate_partial_vaccinated, ' per 1,000 population', '<br>Severe Flu:', rate_severe, ' per 1,000 population'),
  hoverinfo = "text"
) %>%
  layout(
