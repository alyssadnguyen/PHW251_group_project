...
flu_CA_LA <- rbind(flu_CA, flu_LA) %>%
  mutate(quarter = floor_date(dt_diagnosis, "quarter"))
...
```{r} 
flu_vax_month <- inner_join (vax_rate_by_month,flu_rate_by_month, by ="year_month")
...
plot_ly(
 flu_vax_month,
  ...
  type="scatter",
  mode="lines",
  colors=c("darkcyan","darkslateblue"),
