...
plot_ly(
  ...
  layout(
    title = "County Rates of Severe Flu and Total Partially Vaccinated for COVID-19",
...
**Faceted Subplot:** Rates of Severe Flu and Total Partially Vaccinated for COVID-19 by Race/Ethnicity, California
...
subplot(plot1, plot2, nrows = 2, shareX = TRUE) %>%
  layout(
    ...
    title = "Rates of Severe Flu and COVID Partially Vaccinated by Race/Ethnicity in California"
  )
```
