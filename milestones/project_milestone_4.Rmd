...
Interpretation: This table displays rates for severe flu incidence and COVID-19 vaccination by demographic group. By age group, flu incidence increases with older age groups and vaccination is lowest in the youngest group (0-17 years). By race/ethnicity, flu incidence is highest within the White, non-Hispanic group and vaccination is lowest in the Multi-racial group followed by the White, non-Hispanic group. 
...
subplot(plot1, plot2, nrows = 2, shareX = TRUE) %>%
  layout(
    ...
    title = "Rates for Severe Flu and COVID Partially Vaccinated by Demographic Value in California"
  )
